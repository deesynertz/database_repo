...
(1, 'TEST CAMP', 3, 1, 'P.O.Box 01, Mzumbe', 'Critical', '2021-07-19', 200, ' Lorem ipsum represents a long-held tradition for designers,\r\n                          typographers and the like. Some people hate it and argue for\r\n                          its demise, but others ignore the hate as they create awesome\r\n                          tools to help create filler text for everyone from bacon lovers\r\n                          to Charlie Sheen fans.'),
(2, 'DOE CAMP', 4, 2, 'P.o.Box 02 ,Kihonda', 'Normal', '2021-07-19', 389, 'anthicvjd aduyhfuiadyfu');
...
(6, 'Huduma', '20000.00', 1, 1, 'Huduma_01.pdf', 2, '0000-00-00'),
(7, 'Test Charity', '100000.00', 2, 1, 'Test_Charity_02.docx', 2, '0000-00-00');
...
INSERT INTO `feedback` (`ID`, `charityID`, `content`) VALUES
(1, 1, 'ANY_THING_undefined.docx'),
(2, 7, 'Test_Charity_02.docx');
...
(3, 'Deogratias', 'Alison', 'default_img.png', 3, 'P.O.Box 01, Mzumbe', 'Morogoro', 1234567890, 'deo@g.c', '123456', 'Manager'),
(4, 'John', 'Doe', 'default_img.png', 3, 'P.o.Box 02 ,Kihonda', 'Morogoro', 1234567898, 'doe@g.c', '123456', 'Manager');
...
--
ALTER TABLE `feedback`
  ADD CONSTRAINT `feedback_ibfk_1` FOREIGN KEY (`charityID`) REFERENCES `charity` (`ID`) ON DELETE CASCADE ON UPDATE CASCADE;
