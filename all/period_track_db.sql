...
INSERT INTO `answers` (`id`, `answer`, `question_id`, `user_id`, `answeredOn`) VALUES
(1, 'yahp, yebaba', 2, 1, '2021-07-28'),
(2, 'jkdhvjksdfhgj sudguisdg uigysgyusygusy siudyguisy guys ugusgusygisguysd gsud guds', 2, 6, '2021-07-29'),
(3, 'sisd sifuisdufg id fuiodugiodu', 2, 7, '2021-07-29'),
(4, 'zdigzdh dugisdgi suisdfudi', 2, 6, '2021-07-29'),
(5, 'first comment', 1, 6, '2021-07-29'),
(6, 'reply', 9, 6, '2021-08-25');
...
CREATE TABLE `questions` (
  ...
  `user_id` int(11) NOT NULL,
  `askedOn` date NOT NULL DEFAULT current_timestamp()
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
INSERT INTO `questions` (`id`, `question`, `user_id`, `askedOn`) VALUES
(1, 'hello  haehfgeh uiafyeaufyeu eaufyeufyeu world!', 3, '2021-07-03'),
(2, 'uiihjkojojojol zdfzdufudf auyfuayfue fuaeyfueyfueyf efuaeyfuefu efugyaefl afas efuyseru zuifez ?', 4, '2021-07-09'),
(9, 'nimeandika saizi', 6, '2021-08-25'),
(10, 'xdgjsdh g', 6, '2021-08-25');
...
(7, 'Test', '1234567898', '7c222fb2927d828af22f592134e8932480637c0d', 3);
