...
(1, '13212674/t.18', 2, 3, 'gdf@g.c', 'P.O.Box 23', 'allocated'),
(2, '1321266/t.18', 6, 4, 'info@teeoutfits.com', 'P.o.Box 03 any', 'allocated'),
(3, '13301234/t.18', 5, 5, 'info@gmai.com', 'P.o.Box 35, Kimara', 'allocated');
...
(1, 'ITS', 'Information Technology & system ', 1),
(2, 'ICT-M', 'Management', 1),
(3, 'MICT-EDU', 'Education', 2),
(4, 'ICT-B', 'Information and Communication Technology', 1);
...
('13212674/t.18', 3, 'Deogratias', 'Alison', 'R'),
...
CREATE TABLE `supervisor` (
  `id` int(11) NOT NULL,
  `supervisor_id` varchar(14) NOT NULL,
...
('13212674/t.18', '0715206521', 'asha@gmail.com', '1234', 3),
('13300228/t.18', '0747398465', 'maige@gmail.com', 'maige459', 3),
...
('133212/MU/FST', '064567797', 'kivaria@gmail.com', 'kivaria122', 2),
('134345/MU/FST', '0756767678', 'almasi.maguya@mzumbe.ac.tz', '123456', 2),
('136345/MU/FSS', '342543535', 'dfd@g,c', '123456', 2),
('jem/mu/2021', '0744004897', 'one.one@mzumbe.ac.tz', '1234567', 4);
...
--
ALTER TABLE `supervisions`
  MODIFY `supervision_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
