...
--
-- Host: 127.0.0.1
-- Generation Time: Jul 10, 2021 at 09:29 AM
...
--
-- Table structure for table `period_day`
--

CREATE TABLE `period_day` (
  `id` int(11) NOT NULL,
  `bleed_date` date NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;

--
-- Dumping data for table `period_day`
--

INSERT INTO `period_day` (`id`, `bleed_date`) VALUES
(1, '2021-07-10');
...
--
-- Table structure for table `period_period`
--

CREATE TABLE `period_period` (
  `id` int(11) NOT NULL,
  `period` date NOT NULL,
  `low_chance` date NOT NULL,
  `high_chance` date NOT NULL,
  `low_last_chance` date NOT NULL,
  `user_id` int(11) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;

--
-- Dumping data for table `period_period`
--

INSERT INTO `period_period` (`id`, `period`, `low_chance`, `high_chance`, `low_last_chance`, `user_id`) VALUES
(1, '2021-07-14', '2021-07-18', '2021-08-04', '2021-08-08', 1);
...
(2, 'Marha', '11', '356a192b7913b04c54574d18c28d46e6395428ab', 2),
...
--
-- Indexes for table `period_day`
--
ALTER TABLE `period_day`
  ADD PRIMARY KEY (`id`);
...
--
-- Indexes for table `period_period`
--
ALTER TABLE `period_period`
  ADD PRIMARY KEY (`id`),
  ADD KEY `user_id` (`user_id`);
...
--
-- AUTO_INCREMENT for table `period_day`
--
ALTER TABLE `period_day`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
...
--
-- Constraints for table `period_period`
--
ALTER TABLE `period_period`
  ADD CONSTRAINT `period_period_ibfk_1` FOREIGN KEY (`id`) REFERENCES `period_day` (`id`),
  ADD CONSTRAINT `period_period_ibfk_2` FOREIGN KEY (`user_id`) REFERENCES `users` (`id`);
