...
('1618630836971', 'Tahiya', 'H', 'Rama', 'tee@gmail.com', '255755876767', '$2b$10$HEyCbjbbRBKTYbyD3/wXNOPAiToNOV8FWNaXMUBkxvcmF8fqnxA6q', 2, 3, 'http://localhost:4200/assets/media/avatars/IMG_5632_1623529780154.JPG', '2021-05-03 03:40:37'),
('1621461566052', 'Kelvin', 'H', 'Ishengoma', 'kelvin@gmail.com', '', '$2b$10$ZG15RcDZuwZLAuSZJ1VSY.ll..MNvgulcNx2DeFz9FIF33HuYXcSy', 2, 2, 'default_avatar.jpg', '2021-05-19 21:59:26'),
...
('1623231970765', 'Pashua', '', 'Hamad', 'pashua@gmail.com', '0987654321', '$2b$10$ToGdm7EmcIQ55H.U/ASsF.hoeNO/V8n6d2KZcZ2A5Co487bNcrZja', 2, 2, 'http://localhost:4200/assets/media/avatars/avatar4_1623584314645.png', '2021-06-09 09:46:10');
...
(1, 'TEE0215', 0, '2021-04-17 06:02:13'),
(2, 'AXE2881', 0, '2021-05-20 23:24:53'),
(3, 'MET5693', 0, '2021-05-30 11:32:54');
...
(3, 3, 'pk_lcwtux9xasce6qb9dioowbu3azqip4_1', 'sk_gu5cqu50i22x83y1j0y4af130wrguk_1', 0, NULL);
...
INSERT INTO `enterprise_details` (`ID`, `accountID`, `compName`, `email`, `description`, `fee`, `BankCardNo`, `status`, `legalDoc`, `created`) VALUES
('AXE2881', '1621461566052', 'Axetrixhub', 'axe@gmail.com', 'This deal with multiple thing like\n  A: Software developemnt', 8, NULL, 0, '', '2021-05-20 23:24:53'),
('MET5693', '1622351371840', 'metrobile', 'metro@info', 'chemical distributor', 8, '4242 4242 4242 4242', 0, '', '2021-05-30 11:32:54'),
('TEE0215', '1618630836971', 'TEE-PERFUME', 'info@teeperfume.com', 'selling perfume and other cosmetics products in morogoro Tanzania', 8, '4242 4242 4242 4242', 1, '', '2021-04-17 06:02:13');
...
--
ALTER TABLE `documents`
  ADD CONSTRAINT `documents_ibfk_1` FOREIGN KEY (`businessID`) REFERENCES `enterprise_details` (`ID`) ON DELETE CASCADE ON UPDATE CASCADE;
